...
<script>
  ...
  $("#listpekerja").load('/master/data_pekerja/list/0');
  $("#listMitra").load('/master/mitra_kerja/list/0');
        ...
        jQuery(function(){
            $("#frmKL").submit(function(){
                ...
                $.ajax({
                     ...
                     success : function(x){
                         alert(x);
                         window.location = "/master/kategori_layanan";
                     },
                     error : function(){
                        alert("Error");
                     }
...
<?php /**PATH C:\xampp\htdocs\pertamina_hc\resources\views/layouts/app.blade.php ENDPATH**/ ?>